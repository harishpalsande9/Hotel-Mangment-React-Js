...
import { getAllAgents } from "../../services/fakeAgents";
...
import AddAgent from "../../components/crm/addAgent";
...
function AgentsPage() {
  ...
  const [data, setData] = useState(getAllAgents());
  ...
  const columns = [
    ...
    { path: "noOfClients", label: "No Of Clients", isText: false },
    { path: "commission", label: "Commission", isText: false },
    { path: "revenueGenerated", label: "Total Revenue", isText: false },
              ...
              {!reservationFormStatus && (
                <Row className="px-2 no-gutters">
                  <Col className="col-3 py-0">
                    <h4 className="text-dark"> Agents List</h4>
                  </Col>
