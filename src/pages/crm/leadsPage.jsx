...
import { getAllLeads } from "../../services/fakeLeads";
...
function CustomersPage() {
  ...
  const [data, setData] = useState(getAllLeads());
  ...
  const columns = [
    ...
    { path: "source", label: "Source", isText: true },
    { path: "lastFollowUp", label: "Last Follow", isText: false },
    { path: "nextFollowUp", label: "Next FOllow", isText: false },
