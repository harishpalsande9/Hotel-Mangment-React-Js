...
import { getAllMiniBars } from "../../services/fakeMiniBar";
...
import AddMiniBar from "../../components/hk/addMinibar";
...
function MiniBar() {
  ...
  const [data, setData] = useState(getAllMiniBars());
  ...
  const columns = [
    ...
    {
      path: "guestDetails.name",
      label: "Customer Name",
      isText: true,
      status: "confirm",
    },
    { path: "miniBar[0].item", label: "Item Name", isText: true },
    { path: "miniBar[0].price", label: "Price Each", isText: false },
    { path: "miniBar[0].qty", label: "Qty", isText: false },
    { path: "miniBar[0].subTotal", label: "Sub Total", isText: false },
    { path: "payment.grandTotal", label: "Grand Total", isText: false },
    { path: "payment.advance", label: "Advance", isText: false },
    { path: "payment.pending", label: "Pending", isText: false },
            ...
            <div className=" px-2">
              ...
              {!checkinFormStatus && (
                <Row className="px-2 no-gutters">
                  <Col className="col-2 py-0">
                    <h4 className="text-dark"> Mini Bars</h4>
                  </Col>
                  <Col className="">
                    <PlusSquare
