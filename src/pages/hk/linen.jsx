...
import { getAllInventory } from "../../services/fakeInventory";
...
import AddInventory from "../../components/hk/addInventory";
...
function Linen() {
  ...
  const [data, setData] = useState(getAllInventory());
  ...
  const columns = [
    ...
    { path: "pillows", label: "Pillows", isText: false },
    { path: "blankets", label: "Blankets", isText: false },
    { path: "boughtOn", label: "Bought On", isText: true },
              ...
              {!checkinFormStatus && (
                <Row className="px-2 no-gutters">
                  <Col className="col-2 py-0">
                    <h4 className="text-dark"> Linen</h4>
                  </Col>
                  <Col className="">
                    <PlusSquare
