...
import { getAllLostFound } from "../../services/getAllLostFound";
...
import AddLostFound from "../../components/hk/addLostFound";
...
function LostFound() {
  ...
  const [data, setData] = useState(getAllLostFound());
  ...
  const columns = [
    ...
    { path: "customerName", label: "Customer Name", isText: true },
    { path: "lostFound", label: "Lost & Found", isText: true },
    { path: "checkIn", label: "Check In", isText: true },
    { path: "checkOut", label: "Check Out", isText: true },
    { path: "foundBy", label: "Found By", isText: true },
              ...
              {!checkinFormStatus && (
                <Row className="px-2 no-gutters">
                  <Col className="col-3 py-0 ">
                    <h4 className="text-dark"> Lost & Found</h4>
                  </Col>
                  <Col className="">
